...
echo.
echo [7/7] Preparing start script...
copy /Y "%~dp0START_DLAB.bat" "%~dp0START_DLAB.bat" >nul
if errorlevel 1 (
  echo [ERROR] START_DLAB.bat is missing from the package.
  goto :FAIL
)
echo [OK] START_DLAB.bat is ready.
